...
(function() {
  'use strict';
  var App, Chat, FilmThumb, Item, Page, Page_Main, Page_News, Page_Simple, Page_Video, check_app_is_init, error, scroll_to_obj,
  ...
  Page_Main = (function(_super) {
    ...
    Page_Main.prototype.switch_vid = function(type) {
      if (type === current_vid) {
        return;
      }
    ...
    Page_Main.prototype.change_vid_page = function(dir) {
      var op, order, place;
    ...
    Page_Main.prototype.move_to_vid_page = function(type, page) {
      var e, op;
      op = vid_opts[type];
      if (op.cur_page === page) {
        return;
    ...
    Page_Main.prototype.refresh_vid_page_btn = function() {
      var op;
      op = vid_opts[current_vid];
      if (op.cur_page === 0) {
