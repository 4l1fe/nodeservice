...
(function() {
  var Stack, Template, app, e, fs, global_config, templates;
  ...
  Template = (function() {
    ...
    Template.prototype._compile = function() {
      ...
      if (this.fail_status !== void 0) {
        ...
        try {
          return this.req.response_html(this.req.app.jade_compiler.render(this.req.app.conf.theme_path + this.name + this.req.app.conf.jade_ext, this.params()));
        } catch (_error) {
          e = _error;
          this.req.response_code(500);
