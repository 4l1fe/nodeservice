...
var news_list = [
    { cast_name: "Человек года", date: "2014-06-07T20:00:00.000Z", title: 'У Саши и Элины есть договоренность на счет приза в конкурсе "Человек года"', img_url: null, text: 'До финала "Человека года" осталось совсем немного времени и с каждым днем напряжение среди ребят чувствуется все больше и больше. Особенно нервничает Саша Задойнов...' },
