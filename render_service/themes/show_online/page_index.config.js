...
(function (){
    var prepare = function ($) {
        $.params("films", [
            ...
            { id: 1, title: "Дом 2", season: 0, episode: 648, poster: poster_url + 'pict_3.jpg', duration: 2932, start: "2014-08-11T20:00:00.000Z", url: "#" }]);
        $.params("news_list", [
            { cast_name: "Человек года", date: "2014-06-07T20:00:00.000Z", title: 'У Саши и Элины есть договоренность на счет приза в конкурсе "Человек года"', img_url: (img_url + "news-poster.jpg"), text: 'До финала "Человека года" осталось совсем немного времени и с каждым днем напряжение среди ребят чувствуется все больше и больше. Особенно нервничает Саша Задойнов...' },
